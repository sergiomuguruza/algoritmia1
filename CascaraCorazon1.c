...
// accion para cargar los valores de la matriz
void cargarMatriz(int matriz[][100], int n, int m) {
...
// accion para mostrar la matriz con sus elementos cargados
...
int compararSumas(int matriz[][100], int n, int m) {
    int sumaPeriferia = 0;
    int sumaInterior = 0;
